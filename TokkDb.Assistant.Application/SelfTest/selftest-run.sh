...
mkdir -p "$C"
for f in conferences-2025.csv campaigns-wrapped.txt 133804_custom_campaigns_2.csv; do cp "/Users/ts/Student/db/tokkDb/TokkDb.Assistant.Application/SelfTest/$f" "$C/$f"; done
